        ...
        <div class="col">
          	<div class="card shadow">
	            <div class="card-header bg-transparent">
	              <h2 class="mb-0"><i class="fas fa-tools"></i> Tools List
					<button class="btn btn-dark btn-sm float-right" type="button" data-toggle="collapse" data-target="#collapse-filter" style="float: right;"><i class="fas fa-filter"></i> Filters</button>
	              </h2>
            		...
            		<div class="row icon-examples">
						...
						<?php
							...
							foreach ($resultados as $resultado) {
								...
								$name = htmlspecialchars($resultado['name']);
								$category = htmlspecialchars($resultado['category']);
								$category2 = $resultado['category2'] ? htmlspecialchars($resultado['category2']) : null;
								$released = $resultado['released'];
								$categories = htmlspecialchars($resultado['categories'] ?? '');
								$avatar = htmlspecialchars($resultado['avatar'] ?? '');
