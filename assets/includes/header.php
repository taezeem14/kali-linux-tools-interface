...
<nav class="navbar navbar-vertical fixed-left navbar-expand-md navbar-light bg-white" id="sidenav-main">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="sidenav-collapse-main">
      ...
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link" href="debian.php">
            <i class="ni ni-app text-red"></i> System Admin
          </a>
        </li>
      ...
      <!-- Heading -->
      <h6 class="navbar-heading text-muted">SYSTEM</h6>
      <!-- Navigation -->
      <ul class="navbar-nav mb-md-3">
        ...
        <li class="nav-item">
          <a class="nav-link" href="#" onclick="alert('PHP ' + '<?php echo PHP_VERSION; ?>' + ' | MariaDB | Kali Linux'); return false;">
            <i class="ni ni-settings-gear-65"></i> System Info
          </a>
        </li>
      </ul>
    </div>
